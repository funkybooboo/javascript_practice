...
export const addBug = (bug: { project_id: number; description: string }) => api.requested({
    url,
    method: 'post',
    data: bug,
...
export const resolveBug = (id: number) => api.requested({
    url: `${url}/${id}`,
    method: 'patch',
...
export const assignBugToProject = (id: number, project_id: number) => api.requested({
    url: `${url}/${id}`,
    method: 'patch',
    data: { project_id },
