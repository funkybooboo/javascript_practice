...
describe("calculateDiscount", () => {
  it("should return the discounted price if given a valid code", () => {
    // positive test
  ...
  it("should handle a invalid discount code", () => {
    // negative test
...
describe("isPriceInRange", () => {
  ...
  it.each([
    // parameterized test replaces the tests above
...
describe("isValidUsername", () => {
  ...
  it("should return true if username is equal to the length range boundaries", () => {
    // boundary test
...
describe("canDrive", () => {
  ...
  it.each([
    // parameterized tests replace the above code
    {
      age: 1,
      countryCode: "US",
      legalDriveAge: { US: 16, UK: 17 },
      result: false,
    },
    {
      age: 3,
    ...
    "should return $result for ($age, $countryCode, $legalDriveAge)",
    ({ age, countryCode, legalDriveAge, result }) => {
